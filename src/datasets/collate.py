...
def collate_fn(dataset_items: list[dict]):
    ...
    spectrograms = pad_sequence(spectrograms, batch_first=True, padding_value=0.0).transpose(1, -1)
    text_encodeds = pad_sequence(text_encodeds, batch_first=True, padding_value=0).transpose(1, -1)
